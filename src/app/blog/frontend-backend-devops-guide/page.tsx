...
export default function BlogPost() {
  const post = blogPosts.find((post) => post.slug === 'frontend-backend-devops-guide')
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <p className="text-neutral-300">
            Choosing your first specialization in tech can be overwhelming. Let's break down each path and help you make an informed decision.
          </p>
          ...
          <section className="my-12">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 mb-6">
              <p className="text-neutral-300 mb-4">
                Frontend development focuses on creating the user interface and experience:
              </p>
              <ul className="space-y-3 text-neutral-300">
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Core Skills:</strong> HTML, CSS, JavaScript, and modern frameworks like React or Vue</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Focus Areas:</strong> UI/UX implementation, responsive design, and client-side logic</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Career Path:</strong> UI Developer → Frontend Engineer → Lead Frontend Developer</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="my-12">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 mb-6">
              <p className="text-neutral-300 mb-4">
                Backend development deals with server-side logic and data management:
              </p>
              <ul className="space-y-3 text-neutral-300">
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Core Skills:</strong> Server-side languages (Node.js, Python, Java), databases, and APIs</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Focus Areas:</strong> Data processing, security, and system architecture</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Career Path:</strong> Backend Developer → Systems Engineer → Solutions Architect</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="my-12">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 mb-6">
              ...
              <ul className="space-y-3 text-neutral-300">
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Core Skills:</strong> CI/CD, cloud platforms, containerization, and automation</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Focus Areas:</strong> Infrastructure, deployment, and system reliability</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-400 text-xl">•</span>
                  <span><strong className="text-neutral-200">Career Path:</strong> DevOps Engineer → Site Reliability Engineer → DevOps Architect</span>
                </li>
              </ul>
            </div>
          </section>
