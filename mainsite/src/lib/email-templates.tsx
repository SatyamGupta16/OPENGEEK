            ...
            <Section className="mt-8 rounded-lg bg-[#252525] p-6 border border-[#333333]">
              ...
              >
                <div className="bg-[#25D366] hover:bg-[#128C7E] rounded-lg p-4 flex items-center justify-center gap-3 transition-colors duration-200 cursor-pointer">
                  ...
                  <span className="text-white font-semibold text-center text-lg">Click here to join WhatsApp group</span>
                </div>
              </Link>

              <Text className="mt-4 text-[#e1e1e1] leading-relaxed">
                Join our WhatsApp group to:
                <br />• Get instant updates and announcements
                <br />• Connect with fellow community members
                <br />• Participate in discussions and events
                <br />• Get help and support when needed
              </Text>
            </Section>
